...
class ImplicativeExtractor(PresuppositionExtractor):
    ...
    def __init__(self) -> None:
        self.matcher, self.wordlist = self._process_wordlist(
    ...
    def _process_wordlist(self, wordlist: List[str]) -> Tuple[PhraseMatcher, Set[str]]:
        ...
        return (matcher, implicative_verbs)
...
if __name__ == '__main__':
    ...
    print(implicative_extractor.find_trigger(
        nlp(implicative_extractor.get_trigger_canonical_example()))
    )
