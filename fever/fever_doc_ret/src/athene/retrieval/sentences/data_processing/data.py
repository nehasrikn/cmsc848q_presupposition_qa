...
class Data(object):
    ...
    def data_pipeline(self):
        ...
        test_datapath = os.path.join(self.embedding_path, "tmp_data.p")
        ...
        if os.path.exists(words_dict_path):
            ...
            self.word_dict = self.get_complete_words(words_dict_path, None, None, tests)
        ...
        test_indexes_path = os.path.join(self.embedding_path, "tmp_indexes.p")
    ...
    def get_complete_words(self, words_dict_path, train_data=None, dev_data=None, test_data=None):
    ...
    def get_new_test_indexes(self, test_path):
        ...
        new_tests_indexes_path = os.path.join(self.embedding_path, "new_tmp_indexes.p")
