...
class BaseDeepModel(BaseEstimator, ClassifierMixin):
    ...
    def __init__(self, optimizer=tf.compat.v1.train.AdamOptimizer, learning_rate=0.01, initializer=he_init, batch_size=64,
    ...
    def _construct_graph(self, vector_length, n_outputs):
        ...
        X_heads = tf.compat.v1.placeholder(tf.float32, shape=[30, None, vector_length], name="X_heads")
        X_bodies = tf.compat.v1.placeholder(tf.float32, shape=[200, None, vector_length])
