...
class ELMO_ESIM:
    ...
    def __init__(self, optimizer=tf.compat.v1.train.AdamOptimizer, learning_rate=0.0001,
    ...
    def _inter_atten(self, claim, sent, claim_lengths, sent_lengths):
        ...
        with tf.compat.v1.variable_scope('inter-attention') as scope:
    ...
    def mlp(self, inputs):
        ...
        outputs = tf.compat.v1.layers.dense(inputs, 256, activation=tf.nn.tanh, kernel_initializer=self.initializer)
        if self.dropout_rate:
    ...
    def _construct_graph(self):
        ...
        X_h = tf.compat.v1.placeholder(tf.string, shape=[None, None], name="X_heads")
        X_s = tf.compat.v1.placeholder(tf.string, shape=[None, None], name="X_sents")
        ...
        init = [tf.compat.v1.tables_initializer(), tf.compat.v1.global_variables_initializer()]
